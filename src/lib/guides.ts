...
export const META_GUIDE: Record<Locale, MetaGuideCopy> = {
  zh: {
    ...
    fileFindItems: [
      ...
      "若 inbox 找不到，再看同層的 archived_threads（封存）、message_requests（訊息邀請）或 e2ee_cutover。",
  ...
  en: {
    ...
    fileFindItems: [
      ...
      "If it isn’t in inbox, check archived_threads, message_requests, or e2ee_cutover in the same folder.",
